...
<footer class="flex-rw">
  ...
  <ul class="footer-list-top">
    <li>
      <h4 class="footer-list-header">About Platz Laptop</h4></li>
...
</i> 2021 PLATZ COMPANY <address class="footer-address" role="company address">Bergen, NY</address><span class="footer-bottom-rights"> - All Rights Reserved - </span>
    </div>
    <div class="footer-bottom-wrapper">
